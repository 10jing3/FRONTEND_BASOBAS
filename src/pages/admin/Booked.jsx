...
const UserBookedRooms = () => {
  ...
  const [showEsewa, setShowEsewa] = useState({}); // Track which booking's esewa form is open
                ...
                <div className="flex-1 p-6 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="flex items-center text-gray-600 mb-2">
                      ...
                      <span>{booking.room?.location?.split(",")[0]}</span>
                    </div>
                    ...
                    {booking.status !== "accepted" && (
                      <div className="mb-2 text-sm text-gray-400">
                        Owner contact info will be available after your booking
                        is accepted.
                      </div>
                    )}
                    ...
                    <div className="grid grid-cols-3 gap-2 py-3 border-y border-gray-200 mb-4">
                      ...
                      <div className="flex flex-col items-center">
                        <div className="flex items-center text-green-600">
                          ...
                          <span className="font-medium">
                            Rs {booking.room?.price?.toLocaleString() || "N/A"}
                          </span>
                        </div>
                  ...
                  <div className="flex flex-col md:flex-row gap-2 mt-4">
                    ...
                    {booking.status === "accepted" && booking.owner?.phone && (
                      <>
                        <a
